...
if __name__ == '__main__':
    ...
    dim_seq, dim_meta, dim_token, train_dl, val_dl, test_dl = get_data_loader(device, seq_len_max=seq_len_limit, mode=mode_str,
                          use_seq_dim=use_dim_seq, use_meta_dim=use_dim_meta, use_app_dim=use_dim_app)
    ...
    model_name = '{}_{}hidden_{}head_{}layer'.format(model_name, hidden_dim_trans_all, n_heads, n_layers)
    ...
    for i in range(len(val_ds)):
        ...
        print('\n{}-Loss:{}' \
                   ...
                   '\nConfusion Matrix:\n{}\n'.format(ds_names[i], test_loss, acc, prec, recall, f1, mtx))